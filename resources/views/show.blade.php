          ...
          <div class="card-body">
            ...
            <div class="moves">
              ...
              <p class="d-inline-flex gap-1">
                <button class="btn details-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMoves" aria-expanded="false" aria-controls="collapseMoves">
                  Moves 
                </button>
              </p>
            ...
            <div class="Locations">
              ...
              <p class="d-inline-flex gap-1">
                <button class="btn details-btn" type="button" data-bs-toggle="collapse" data-bs-target="#collapseLocations" aria-expanded="false" aria-controls="collapseLocations">
                  Locations 
                </button>
              </p>  
